    ...
    class Infinite_photography_author_widget extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                ...
                <textarea class="widefat" id="<?php echo $this->get_field_id( 'infinite_photography_author_short_disc' ); ?>" name="<?php echo $this->get_field_name( 'infinite_photography_author_short_disc' ); ?>"><?php echo esc_html( $infinite_photography_author_short_disc ); ?></textarea>
            </p>
            <p>
