...
if ( ! function_exists( 'infinite_photography_skip_to_content' ) ) :
    ...
    function infinite_photography_skip_to_content() {
        ...
        ?>
        <a class="skip-link screen-reader-text" href="#<?php echo esc_attr($infinite_photography_content_id);?>" title="link"><?php esc_html_e( 'Skip to content', 'infinite-photography' ); ?></a>
    <?php
    }
                ...
                <div class="header-container">
                    <div class="site-branding clearfix">
                        <div class="site-logo acme-col-3">
                            ...
                            endif;?><!--infinite-photography-header-id-display-opt-->
                        </div><!--site-logo-->
