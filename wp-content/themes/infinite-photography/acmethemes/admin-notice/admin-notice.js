...
jQuery( document ).ready( function ( $ ) {
	...
	$( '.at-gsm-btn' ).click( function ( e ) {
		...
		$( this ).text( infinite_photography_adi_install.btn_text );
		...
		$.ajax({
			...
			data: {
				...
				security : infinite_photography_adi_install.nonce,
				...
				setTimeout(function(){
					$.ajax({
						...
						success:function( response ) {
							...
							redirect_uri         = infinite_photography_adi_install.adminurl+'/themes.php?page=advanced-import&browse=all&at-gsm-hide-notice=welcome';
