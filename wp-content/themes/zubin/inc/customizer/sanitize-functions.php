<?php
/**
 * Zubin Theme Options Sanitization Functions
 *
 * @package Zubin
 */
 ...
 */
function zubin_sanitize_select( $input, $setting ) {
 ...
 */
function zubin_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function zubin_sanitize_post( $input ) {
 ...
 */
function zubin_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since 1.0
 */
function zubin_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function zubin_sanitize_number_range( $number, $setting ) {
 ...
 * @return string
 */
function zubin_sanitize_date_time( $input ) {
